...
public abstract class AdvancedPhysicDrawnObject extends BasicPhysicDrawnObject
{
	...
	private void setRotationMomentumTo(AdvancedPhysicDrawnObject other, 
	 ...
	 * @param steps How many steps does the collision take to happen
	 */
	public void collideWith(AdvancedPhysicDrawnObject p, 
	...
	private void collideWith(AdvancedPhysicDrawnObject p, 
	...
	*/
	...
	private double getDirectionalEndMomentumOnCollisionWith(
			AdvancedPhysicDrawnObject other, double direction)
	{
